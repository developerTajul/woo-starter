...
if ( ! function_exists( 'woo_starter_setup' ) ) :
	...
	function woo_starter_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'woo-starter' ),
		) );
 ...
 */
function woo_starter_scripts() {
	wp_enqueue_style( 'woo-starter-style', get_stylesheet_uri() );

	wp_enqueue_script( 'woo-starter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'woo-starter-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'woo_starter_scripts' );
